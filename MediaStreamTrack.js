...
class MediaStreamTrack extends EventTarget(MEDIA_STREAM_TRACK_EVENTS) {
  ...
  static takePicture(options: SnapshotOptions, trackId: string, success: (any) => {}, error: (any) => {}) {
    let nativeOptions = convertToNativeOptions(options);
    WebRTCModule.takePicture(nativeOptions, trackId, success, error);
  }
